# Project Zomboid Immersive Framework - Gemini Instructions
...
**Step 2: Roll**
Generate a random number between 0 and 1. If the number is less than trigger_chance, a handcuff activates.
...
When the player reports events during play:
- Immediately update the relevant files (map.txt, character.txt)
- Don't wait until end of session
- Keep tracking coordinates, items found, kills
- Log timestamps when the player provides them
